...
public class Square extends GameObj {
    ...
    public static final int INIT_POS_Y = 700;
     ...
     * correct parameters.
     */
    public Square(int width, int courtWidth, int courtHeight, Color color) {
        super(
                INIT_VEL_X, INIT_VEL_Y, INIT_POS_X, INIT_POS_Y, width, LENGTH, courtWidth,
                courtHeight
        );
