...
public abstract class GameObj {
    ...
    public void setWidth(int newWidth) {
        this.width = newWidth;
        this.maxX = this.courtWidth - width;
    }
    ...
    public boolean willIntersect(GameObj that) {
        ...
        boolean b = thisNextX + this.width >= thatNextX
     ...
     */
    public void bounce(Direction d, int barSpeed) {
        if (d == null) {
            return;
        }
    ...
    public Direction hitObj(GameObj that) {
        if (this.willIntersect(that)) {
            int centerX = (this.px + this.width / 2);
            double dx = that.px + that.width / 2 - centerX;
            ...
            if (that.px < centerX && centerX < (that.px + that.width)) {
                if (dy > 0) {
